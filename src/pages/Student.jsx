...
const Student = () => {
  ...
  const handleClose = () => {
    setloading(true);
    axios.post("https://backend-6kkf.onrender.com/creatstudent", {
      ...
      .then(() => {
        ...
        setShow(false);
        setUpdate(false);
        axios.get("https://backend-6kkf.onrender.com/allstudent")
  ...
  const handleCloseForUpdate = () => {
    ...
    setloading(true);
    axios.patch(`https://backend-6kkf.onrender.com/student/${studentObjectId}`, {
      studentname: studentname,
      departmentname: departmentname,
      studentid: studentid,
    })
  ...
  const handleShowModal = (id) => {
    setUpdate(true)
    axios.get(`https://backend-6kkf.onrender.com/student/${id}`).then((data)=>{
  ...
  useEffect(() => {
   ...
   let handleDelete = async (id) => {
    try {
      await axios.post("https://backend-6kkf.onrender.com/delete", { id }); 
      
      const { data } = await axios.get("https://backend-6kkf.onrender.com/allstudent");
      setstudentList(data); 
    } catch (err) {
      console.log(err);
    }
