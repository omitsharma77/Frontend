...
const Teacher = () => {
  ...
  const handleClose = () => {
    ...
    setloading(true);
    axios.post("https://backend-6kkf.onrender.com/creatteacher", {
      ...
      .then(() => {
        ...
        setShow(false);
        setUpdate(false);
        axios.get("https://backend-6kkf.onrender.com/allteacher")
  ...
  const handleCloseForUpdate = () => {
    ...
    setloading(true);
    axios.patch(`https://backend-6kkf.onrender.com/teacher/${teacherObjectId}`, {
      teachername: teachername,
      departmentname: departmentname,
      phonenumber: phonenumber,
    })
  ...
  const handleShowModal = (id) => {
    setUpdate(true);
    axios.get(`https://backend-6kkf.onrender.com/teacher/${id}`).then((data) => {
  ...
  let handleDelete = async (id) => {
    try {
      await axios.post("https://backend-6kkf.onrender.com/deleteTeacher", { id });
      const { data } = await axios.get("https://backend-6kkf.onrender.com/allteacher");
      setteacherList(data);
    } catch (err) {
      console.log(err);
    }
